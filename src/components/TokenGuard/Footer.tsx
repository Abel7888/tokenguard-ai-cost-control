      ...
      <Dialog open={privacyOpen} onOpenChange={setPrivacyOpen}>
        <DialogContent className="max-h-[80vh] overflow-y-auto border-border bg-background text-foreground">
          <DialogHeader>
            ...
            <DialogDescription className="sr-only">TokenGuard privacy policy</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 font-mono text-sm text-muted-foreground">
            <p><strong className="text-foreground">Effective Date:</strong> January 1, 2026</p>
            <p>TokenGuard Inc. ("we", "us") is committed to protecting your privacy. This policy explains how we handle your information.</p>
            ...
            <p>Your email is used solely to communicate with you about TokenGuard product updates, early access, and launch information. We will never sell, rent, or share your personal information with third parties.</p>
      ...
      <Dialog open={termsOpen} onOpenChange={setTermsOpen}>
        <DialogContent className="max-h-[80vh] overflow-y-auto border-border bg-background text-foreground">
          <DialogHeader>
            ...
            <DialogDescription className="sr-only">TokenGuard terms of service</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 font-mono text-sm text-muted-foreground">
            <p><strong className="text-foreground">Effective Date:</strong> January 1, 2026</p>
            <p>By accessing or using TokenGuard's website and services, you agree to these terms.</p>
            <h3 className="text-foreground font-bold">Intellectual Property</h3>
            <p>All content, designs, code, logos, and materials on this website are the intellectual property of TokenGuard Inc. You may not reproduce, distribute, or create derivative works without our written permission.</p>
            <h3 className="text-foreground font-bold">Use of Service</h3>
            <p>TokenGuard provides AI API cost monitoring and optimisation tools. You agree to use the service only for lawful purposes and in accordance with these terms.</p>
            <h3 className="text-foreground font-bold">Limitation of Liability</h3>
            <p>TokenGuard is provided "as is". We are not liable for any indirect, incidental, or consequential damages arising from use of our platform. Savings estimates are based on averages and are not guaranteed.</p>
